...
"""
Wrapper script to run the Renaissance layout recognition application with LayoutLMv3.
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Run Renaissance layout recognition with LayoutLMv3')
    parser.add_argument('--input_dir', type=str, default='data/renaissance/val',
                        help='Directory containing input images')
    parser.add_argument('--output_dir', type=str, default='results/layoutlmv3_recognition',
                        help='Directory to save results')
    parser.add_argument('--model_path', type=str, default='models/layoutlmv3/best_model.pth',
                        help='Path to pretrained model (optional, will use pretrained if not found)')
...
def main():
    ...
    print("Loading model...")
    try:
        model = create_layoutlmv3_model(
            pretrained_path=args.model_path if os.path.exists(args.model_path) else None, 
            device=device
        )
        print("Loaded LayoutLMv3 model successfully")
...
<head>
    ...
    <title>LayoutLMv3 Recognition Results</title>
    <style>
        body {
...
<body>
    <h1>LayoutLMv3 Recognition Results</h1>
    <p style="text-align: center;">This page shows the results of the LayoutLMv3 model on the Renaissance dataset.</p>
    ...
    <div class="footer">
        <p>LayoutLMv3 Recognition - Generated on <span id="date"></span></p>
        <script>
